...
namespace Win.AutoloteL3 {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, CategoriaRow parentCategoriaRowByCategoria_Producto, double Precio, int Existencia, byte[] Foto, bool Activo) {
                ...
                if ((parentCategoriaRowByCategoria_Producto != null)) {
                    columnValuesArray[2] = parentCategoriaRowByCategoria_Producto[0];
                }
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClienteRow AddClienteRow(string Nombre, string Identidad, string Telefono, string Direccion, bool Activo) {
...
namespace Win.AutoloteL3.DataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([ID] = @Original_ID) AND ([CategoriaId] = @O" +
                "riginal_CategoriaId) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Orig" +
                "inal_Existencia) AND ([Activo] = @Original_Activo))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [CategoriaId], [Precio], [Existencia], [Foto], [Activo]) VALUES (@Descripcion, @CategoriaId, @Precio, @Existencia, @Foto, @Activo);
SELECT ID, Descripcion, CategoriaId, Precio, Existencia, Foto, Activo FROM Producto WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [CategoriaId] = @CategoriaId, [Precio] = @Precio, [Existencia] = @Existencia, [Foto] = @Foto, [Activo] = @Activo WHERE (([ID] = @Original_ID) AND ([CategoriaId] = @Original_CategoriaId) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([Activo] = @Original_Activo));
SELECT ID, Descripcion, CategoriaId, Precio, Existencia, Foto, Activo FROM Producto WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Win.AutoloteL3.Properties.Settings.Default.AutoloteConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Descripcion, CategoriaId, Precio, Existencia, Foto, Activo FROM dbo.Pr" +
                "oducto";
        ...
        public virtual int Delete(int Original_ID, int Original_CategoriaId, double Original_Precio, int Original_Existencia, bool Original_Activo) {
        ...
        public virtual int Insert(string Descripcion, int CategoriaId, double Precio, int Existencia, byte[] Foto, bool Activo) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, int CategoriaId, double Precio, int Existencia, byte[] Foto, bool Activo, int Original_ID, int Original_CategoriaId, double Original_Precio, int Original_Existencia, bool Original_Activo, int ID) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, int CategoriaId, double Precio, int Existencia, byte[] Foto, bool Activo, int Original_ID, int Original_CategoriaId, double Original_Precio, int Original_Existencia, bool Original_Activo) {
            return this.Update(Descripcion, CategoriaId, Precio, Existencia, Foto, Activo, Original_ID, Original_CategoriaId, Original_Precio, Original_Existencia, Original_Activo, Original_ID);
        }
    }
...
SELECT Id, Fecha, ClienteId, Subtotal, Impuesto, Total, Activo FROM Factura WHERE (Id = @Id)";
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [Nombre] = @Nombre, [Identidad] = @Identidad, [Telefono] = @Telefono, [Direccion] = @Direccion, [Activo] = @Activo WHERE (([ID] = @Original_ID) AND ([Activo] = @Original_Activo));
SELECT ID, Nombre, Identidad, Telefono, Direccion, Activo FROM Cliente WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID, Nombre, Identidad, Telefono, Direccion, Activo FROM dbo.Cliente";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Nombre, string Identidad, string Telefono, string Direccion, bool Activo) {
            if ((Nombre == null)) {
                this.Adapter.InsertCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Identidad, string Telefono, string Direccion, bool Activo, int Original_ID, bool Original_Activo, int ID) {
            if ((Nombre == null)) {
                this.Adapter.UpdateCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Identidad, string Telefono, string Direccion, bool Activo, int Original_ID, bool Original_Activo) {
            return this.Update(Nombre, Identidad, Telefono, Direccion, Activo, Original_ID, Original_Activo, Original_ID);
        }
    }
